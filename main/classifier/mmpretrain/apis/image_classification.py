...
class ImageClassificationInferencer(BaseInferencer):
    ...
    Example:
        1. Use a pre-trained mmpretrain in MMPreTrain to inference an image.
        ...
        2. Use a config file and checkpoints to inference multiple images on GPU,
    ...
    def list_models(pattern: Optional[str] = None):
        """List all available mmpretrain names.
